...
import {
  deleteRealEstatePost,
  realEstatePostFulfilled,
} from "@/utils/realEstatePost";
import RSEditPost from "./RSEditPost";

type Props = {
  post: RealEstatePost;
};

const RSPostMenu = ({ post }: Props) => {
