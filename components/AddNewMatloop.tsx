...
const AddNewMatloop = () => {
  ...
  return (
    <section className={`mt-16 ${!isArabic && "ltr"}`}>
      ...
      <div className="mx-auto px-4 flex flex-col justify-center w-full pt-20 pb-12 bg-gray-100  rounded-2xl">
        <div className="flex flex-col md:flex-row md:justify-between justify-center items-center md:items-start w-full">
          ...
          <div className="flex flex-col items-center justify-center mb-6 md:mb-0 w-1/2 md:px-10">
            ...
            <p className="text-gray-600 text-center">{t("description1")}</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center mb-6 md:mb-0 w-1/2 md:px-10">
            ...
            <p className="text-gray-600 text-center">{t("description2")}</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center w-1/2 md:px-10">
            ...
            <p className="text-gray-600 text-center">{t("description3")}</p>
          </div>
        </div>
        ...
        <Link
          href="/new-matloop"
          locale={locale}
          className={`btn2 bg-secondary mt-20 flex justify-center mx-auto`}
        >
          {t("addnewMatloop")}
        </Link>
      </div>
