  ...
  const handleDeleteComment = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteDeviceComment(post, comment?.commentId);
        Swal.fire({
    ...
    <div className="mb-5 mx-2">
      <div className="flex flex-col bg-gray-50 dark:bg-gray-700 h-fit w-full py-2 px-3 rounded-xl">
        ...
        <div className="flex flex-row justify-between items-start w-full">
          <div
            className={`btn2 bg-gray-200 dark:bg-gray-600 dark:text-gray-300 text-gray-500 flex flex-row items-center gap-1 ${
              !isArabic && "ltr"
            }`}
          >
            <span>{svgClock}</span>{" "}
...
export default EDCommentSection;
