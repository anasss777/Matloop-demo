...
import { svgBigUser, svgProperty } from "@/components/svgsPath";
import RSPostDetails from "@/components/RealEstate/RSPostDetails";
import RSPostComments from "@/components/RealEstate/RSPostComments";
const locales = ["ar", "en"];
...
const Post = ({ params }: Props) => {
  ...
  if (loading) {
    return (
      ...
      >
        <Breadcrumbs
          categorySvg={svgProperty}
          categoryName={t("realEstate")}
